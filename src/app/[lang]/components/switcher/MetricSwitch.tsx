...
import { useSelector, useDispatch } from '@/app/[lang]/lib/redux/store'
import {
  toggleSwitch,
  selectSwitcherSystem,
  selectSwitcherIsMetric,
} from '@/app/[lang]/lib/redux/slices/switcherSlice'
import { resetForm, setIsMetric } from '@/app/[lang]/lib/redux/slices/formSlice'
