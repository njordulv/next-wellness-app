...
import { setEmailValue, selectEmailValue } from '../lib/redux/slices/emailSlice'
import {
  selectPlans,
  selectPlanOne,
  selectPlanTwo,
  ...
  return (
    <>
      ...
      >
        ...
        <section className="flex flex-row items-center justify-center gap-1 text-5xl my-6 text-dark">
          <LiaCcVisa />
          <LiaCcMastercard />
          <LiaCcAmex />
          <LiaCcDiscover />
