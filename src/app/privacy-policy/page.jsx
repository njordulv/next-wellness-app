  ...
  return (
    <>
      ...
      <div className="text-left">
        <p>
          At Next Wellness App, we deeply value your privacy and are committed
        ...
        <h3>Consent</h3>
        <p>
          By using Next Wellness App, you consent to our Privacy Policy and
        ...
        <p>Thank you for choosing Next Wellness App.</p>
      </div>
    </>
  )
}
